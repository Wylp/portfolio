...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 bg-bg-surface border-b border-border">
      <div className="max-w-[900px] mx-auto px-6 h-full flex items-center justify-between">
        {/* Logo */}
        <a href="#" className="font-bold text-text-primary text-lg select-none">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <button
            ...
            className="flex items-center gap-1 border border-border rounded-full px-3 py-1 text-xs cursor-pointer"
          >
            ...
            <div className="flex flex-col gap-2 px-6 py-6">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-base text-text-secondary hover:text-text-primary transition py-2"
                >
                  {t.nav[link.key]}
                </a>
              ))}
